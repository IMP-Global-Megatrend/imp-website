      ...
      <footer className="bg-primary text-white" data-transition-region="footer">
        <div className="container py-14 md:py-16">
          ...
          <div className="grid md:grid-cols-3 gap-10 lg:gap-16">
            ...
            <nav className="flex flex-col gap-3">
              <a
                href="https://www.linkedin.com/company/imp-global-megatrend-umbrella-fund/"
                rel="noreferrer"
                target="_blank"
                className="mt-1 inline-flex items-center gap-2 text-white/80 hover:text-white transition-colors"
                aria-label="IMP Global Megatrend on LinkedIn"
              >
                <svg
              ...
              <a
                ...
                aria-label="IMP Global Megatrend on Instagram"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="20"
              ...
              <a
                ...
                target="_blank"
                className="inline-flex items-center gap-2 text-white/80 hover:text-white transition-colors"
                aria-label="MRB Fund Partners AG on LinkedIn"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="20"
